...
contributor; foreign nodes refuse to serialize."
  ...
  (let ((tmp "/tmp/pine-world-probe.txt"))
    ...
    (let ((arr (pine.store:store '(:world :arrangement)))
      ...
      (pine.buffer:kill-buffer "pine-world-probe.txt") (sleep 0.1)
      (pine.editor::%seed-editor-tree *client* :world nil)
      (pine.render:relayout)
      ...
      (let* ((leaves (pine.editor::%editor-leaves *client*))
        ...
        (is (string= "alpha"
                     (subseq (btext (pine.buffer:buffer "pine-world-probe.txt"))
                             0 5))))))
  (let ((scratch (pine.buffer:buffer "scratch")))
  ...
  (pine.buffer:kill-buffer "pine-world-probe.txt")
  (setf (pine.var:var :world-save) nil)
  (pine.editor::%seed-editor-tree *client* :world nil)
  (pine.render:relayout)
  (setf (pine.client:current-buffer *client*) (pine.buffer:buffer "scratch")))
